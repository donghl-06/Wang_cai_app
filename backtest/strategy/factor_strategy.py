...
class FactorStrategy(Strategy):
    ...
    def onTradeEvent(self, execution) -> List:
        """处理逐笔成交"""
        trade_record = {
                'Exchange': execution.Exchange,
                'Instrument': execution.Instrument,
                'Time': execution.Time,
                'ChannelNo': execution.ChannelNo,
                'TradeIndex': execution.TradeIndex,
                'Price': execution.Price,
                'Volume': execution.Volume,
                'ExecType': execution.ExecType,
                'BuyNo': execution.BuyNo,
                'SellNo': execution.SellNo,
                'TradeBSFlag': execution.TradeBSFlag,
                'BizIndex': execution.BizIndex
            }
        self.trade_detail_q.put(trade_record)
